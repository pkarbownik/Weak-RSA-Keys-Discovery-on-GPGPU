...
/**
 * \brief Select enum algorithms value based on string algorithm
 *
 * \param[in, out] algorithm as a string
...
/**
 * \brief Select enum procUnit value based on string cpu_gpu
 *
 * \param[in, out] cpu_gpu kind of processing unit as a string
 * \return procUnit kind of processing unit enum value
 */
